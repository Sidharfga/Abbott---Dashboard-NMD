...
@Component({
  selector: 'app-Fin33',
  templateUrl: './Fin33.component.html',
  styleUrls: ['./Fin33.component.scss']
})
export class Fin33Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi33', am4charts.XYChart);
    chart.height = 500;
