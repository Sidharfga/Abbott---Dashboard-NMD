...
@Component({
  selector: 'app-Fin35',
  templateUrl: './Fin35.component.html',
  styleUrls: ['./Fin35.component.scss']
})
export class Fin35Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi35', am4charts.XYChart);
    chart.height = 500;
