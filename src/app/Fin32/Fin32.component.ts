...
@Component({
  selector: 'app-Fin32',
  templateUrl: './Fin32.component.html',
  styleUrls: ['./Fin32.component.scss']
})
export class Fin32Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi32', am4charts.XYChart);
    chart.height = 500;
