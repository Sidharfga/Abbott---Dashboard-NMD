...
@Component({
  selector: 'app-Fin38',
  templateUrl: './Fin38.component.html',
  styleUrls: ['./Fin38.component.scss']
})
export class Fin38Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi38', am4charts.XYChart);
    chart.height = 500;
