...
@Component({
  selector: 'app-Fin37',
  templateUrl: './Fin37.component.html',
  styleUrls: ['./Fin37.component.scss']
})
export class Fin37Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi37', am4charts.XYChart);
    chart.height = 500;
