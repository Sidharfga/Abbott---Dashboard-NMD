...
@Component({
  selector: 'app-Fin8',
  templateUrl: './Fin8.component.html',
  styleUrls: ['./Fin8.component.scss']
})
export class Fin8Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi8', am4charts.XYChart);
    chart.height = 500;
  ...
  chart.data = [
      ...
      {
        "program": "Remote Operating-Susmitha",
        "POValue": 19440.00,
        "RemainingForecast": 0,
              "consumed": [ 19440.00],
   
        "consumedLabels": [ 'Remote Operating-Susmitha'],
              "dummydata":'',
