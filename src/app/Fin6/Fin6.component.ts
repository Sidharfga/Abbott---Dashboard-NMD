...
@Component({
  selector: 'app-Fin6',
  templateUrl: './Fin6.component.html',
  styleUrls: ['./Fin6.component.scss']
})
export class Fin6Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi6', am4charts.XYChart);
    chart.height = 480;
