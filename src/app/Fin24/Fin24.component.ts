...
@Component({
  selector: 'app-Fin24',
  templateUrl: './Fin24.component.html',
  styleUrls: ['./Fin24.component.scss']
})
export class Fin24Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi24', am4charts.XYChart);
    chart.height = 500;
