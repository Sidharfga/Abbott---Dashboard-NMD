...
@Component({
  selector: 'app-Fin30',
  templateUrl: './Fin30.component.html',
  styleUrls: ['./Fin30.component.scss']
})
export class Fin30Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi30', am4charts.XYChart);
    chart.height = 500;
