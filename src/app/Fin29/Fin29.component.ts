...
@Component({
  selector: 'app-Fin29',
  templateUrl: './Fin29.component.html',
  styleUrls: ['./Fin29.component.scss']
})
export class Fin29Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi29', am4charts.XYChart);
    chart.height = 500;
