...
@Component({
  selector: 'app-Fin7',
  templateUrl: './Fin7.component.html',
  styleUrls: ['./Fin7.component.scss']
})
export class Fin7Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi7', am4charts.XYChart);
 
  chart.data = [
    
    {
        "program": "Remote Operating-Ronnie",
        "POValue": 44187.00,
        "RemainingForecast": 0,
              "consumed": [ 44187.00],
   
        "consumedLabels": [ 'Remote Operating-Ronnie'],
              "dummydata":'',
