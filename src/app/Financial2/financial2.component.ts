...
@Component({
  selector: 'app-financial2',
  templateUrl: './financial2.component.html',
  styleUrls: ['./financial2.component.scss'],
})
export class Financial2Component implements OnInit {
  finance: any = [];
  finance1: any = [];
  burndown: any = [];
  programNames: any = [];
