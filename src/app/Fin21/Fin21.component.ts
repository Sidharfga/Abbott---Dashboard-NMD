...
@Component({
  selector: 'app-Fin21',
  templateUrl: './Fin21.component.html',
  styleUrls: ['./Fin21.component.scss']
})
export class Fin21Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi21', am4charts.XYChart);
    chart.height = 500;
