...
@Component({
  selector: 'app-Fin26',
  templateUrl: './Fin26.component.html',
  styleUrls: ['./Fin26.component.scss']
})
export class Fin26Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi26', am4charts.XYChart);
    chart.height = 500;
