...
@Component({
  selector: 'app-Fin22',
  templateUrl: './Fin22.component.html',
  styleUrls: ['./Fin22.component.scss']
})
export class Fin22Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi22', am4charts.XYChart);
    chart.height = 500;
