...
@Component({
  selector: 'app-Fin27',
  templateUrl: './Fin27.component.html',
  styleUrls: ['./Fin27.component.scss']
})
export class Fin27Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi27', am4charts.XYChart);
    chart.height = 500;
