...
@Component({
  selector: 'app-Fin28',
  templateUrl: './Fin28.component.html',
  styleUrls: ['./Fin28.component.scss']
})
export class Fin28Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi28', am4charts.XYChart);
    chart.height = 500;
