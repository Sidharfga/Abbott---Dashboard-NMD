...
@Component({
  selector: 'app-fin2',
  templateUrl: './fin2.component.html',
  styleUrls: ['./fin2.component.scss']
})
export class Fin2Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi2', am4charts.XYChart);
 
  chart.data = [
    
    {
      "program": "Mobile Ops - Mrkt Expn",
      "POValue": 302652.00,
      "RemainingForecast": 0,
            "consumed": [234864.00, 67788.00],
 
      "consumedLabels": ['Mobile Ops - Mrkt Expn', 'Cloud Ops 1'],
            "dummydata":'',
 
    },
    {
        "program": "Mobile Ops - Jupiter/Oahu",
        "POValue": 308280.00,
        "RemainingForecast": 0,
              "consumed": [281857.92, 26422.00],
   
        "consumedLabels": ['Mobile Ops - Jupiter/Oahu', 'Cloud Ops 1'],
              "dummydata":'',
