...
@Component({
  selector: 'app-fin1',
  templateUrl: './fin1.component.html',
  styleUrls: ['./fin1.component.scss']
})
export class Fin1Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi1', am4charts.XYChart);
    chart.height = 420;
