...
@Component({
  selector: 'app-Fin31',
  templateUrl: './Fin31.component.html',
  styleUrls: ['./Fin31.component.scss']
})
export class Fin31Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi31', am4charts.XYChart);
    chart.height = 500;
