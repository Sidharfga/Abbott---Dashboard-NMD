...
@Component({
  selector: 'app-Fin4',
  templateUrl: './Fin4.component.html',
  styleUrls: ['./Fin4.component.scss']
})
export class Fin4Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi4', am4charts.XYChart);
    chart.height = 530;
  ...
  chart.data = [
    ...
    {
        "program": "Hercules(Hercules 3)",
        "POValue": 528500.00,
        "RemainingForecast": 0,
              "consumed": [528500.00],
   
        "consumedLabels": ['Hercules(Hercules 3)'],
              "dummydata":'',
   
      },
      {
        "program": "Sapphire - Onyx-2",
        "POValue": 278777.99,
        "RemainingForecast": 0,
              "consumed": [ 278777.99],
   
        "consumedLabels": [ 'Sapphire - Onyx-2'],
              "dummydata":'',
