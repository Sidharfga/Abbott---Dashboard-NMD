...
@Component({
  selector: 'app-Fin34',
  templateUrl: './Fin34.component.html',
  styleUrls: ['./Fin34.component.scss']
})
export class Fin34Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi34', am4charts.XYChart);
    chart.height = 500;
