...
@Component({
  selector: 'app-Fin36',
  templateUrl: './Fin36.component.html',
  styleUrls: ['./Fin36.component.scss']
})
export class Fin36Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi36', am4charts.XYChart);
    chart.height = 500;
