...
@Component({
  selector: 'app-Fin12',
  templateUrl: './Fin12.component.html',
  styleUrls: ['./Fin12.component.scss']
})
export class Fin12Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi12', am4charts.XYChart);
    chart.height = 500;
  ...
  chart.data = [
   ...
   
    {
      ...
      {
        "program": "OrionMRI_Trim_ArtemisChg",
        "POValue": 25594.00,
        "RemainingForecast": 0,
              "consumed": [ 25594.00],
   
        "consumedLabels": [ 'OrionMRI_Trim_ArtemisChg'],
              "dummydata":'',
