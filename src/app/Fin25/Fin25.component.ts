...
@Component({
  selector: 'app-Fin25',
  templateUrl: './Fin25.component.html',
  styleUrls: ['./Fin25.component.scss']
})
export class Fin25Component implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    let chart = am4core.create('fi25', am4charts.XYChart);
    chart.height = 500;
